...
to.plot[,method:=str_replace_all(method,c("mefisto"="MEFISTO","knn"="kNN","mofa"="MOFA2", "random"="Random"))]

p <- ggboxplot(to.plot[seed=="1"], x="method", y="mae", fill="method", group="seed", outlier.shape=NA) + # add = "dotplot"
  facet_wrap(~facet, nrow=2) +
  # scale_fill_brewer(palette="Dark2") +
  scale_fill_manual(values=c("MEFISTO"="steelblue3", "MOFA2"="gray", "kNN"="darkorange","Random"="darkgreen")) +
